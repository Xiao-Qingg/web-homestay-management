        ...
        <form method="POST" action="../../../handles/homestay_process.php" id="homestayForm" class="mt-4">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price_per_night" name="price_per_night" 
                               placeholder="" min="0" step="1000" required>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="status" name="status">
                    <option value="Hoạt động" <?= (($_POST['status'] ?? 'Hoạt động') === 'Hoạt động') ? 'selected' : '' ?>>Hoạt động</option>
                    <option value="Không hoạt động" <?= (($_POST['status'] ?? '') === 'Không hoạt động') ? 'selected' : '' ?>>Không hoạt động</option>
                </select>
            </div>

            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Lưu Homestay
                </button>
                <a href="homestays.php" class="btn btn-secondary">
